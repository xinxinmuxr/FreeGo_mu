        ...
        <form action="">
            ...
            <div class="hotel-panel">
                ...
                <div class="info">
                    ...
                    <p class="address">地址：金田路2028号皇岗商务中心26楼办理入住, 深圳, 中国 </p>
                </div>
                <div class="extra">
                    <div class="item" name="date-check-in" data-val="2021-06-13">
                        <div class="t">2021年06月</div>
                        <div class="m">13</div>
                        <div class="b">星期日入住</div>
                    </div>
                    <div class="item" name="date-check-out" data-val="2021-06-14">
                        <div class="t">2021年06月</div>
                        <div class="m">14</div>
                        <div class="b">星期一离店</div>
                    </div>
                    <div class="item">
                        <div class="t">客房数</div>
                        <div class="m">1</div>
            ...
            <div class="form-panel">
                <!-- 房间信息 S -->
                <div class="form-block form-room" id="_j_form_room_container"><div class="room-item"><div class="mod-title">房间<em class="room-index">1</em> - <em class="room-name">雅致双床房</em> (必填)</div><p class="sub">入住信息：<span class="text">2成人</span><span class="text plain-container _j_plain_select_container show"><span class="ui-plain"><em>双床1.2米</em><input type="hidden" name="select" data-id="66502"></span></span></p><div class="extra-tips">此入住人数为查询价格时设置的人数,如变更请在前一页日期旁修改并重新查询价格</div>
                    <div class="f-row select-container _j_select_container"></div>
                    <div class="line"></div>
                    <div class="name-list-container _j_name_list_container">
                        <div class="f-row">
                            <div class="ui-input">
                                <input type="text" class="last-name input-name">
                                <label>姓</label>
                                <i class="icon-success"></i>
                            </div>
                            <div class="ui-input">
                            <input type="text" class="first-name input-name">
                            <label>名</label>
                            <i class="icon-success"></i>
                            </div>
                            ...
                            <a class="btn-people" href="javascript:void(0);" btn-name="add">
                                <i class="i-add"></i>第一位入住人
                            </a>
                        </div>
                        <div class="f-row">
                            <div class="ui-input">
                            ...
                            <a href="${pageContext.request.contextPath}/HotelServlet?methods=toReserve&ruzhu=<%%>" class="btn-people" href="javascript:void(0);" btn-name="add">
                                <i class="i-add"></i>第二位入住人
                            </a>
                        </div>
